    ...
    return (
      <section className="metrics_feature_area" id="feature">
        <div className="title">
          ...
          <p className="small-text">
            You have total {this.state.totalAppsCountRequest.count} job
            applications so far! That means you have already taken{" "}
            {this.state.totalAppsCountRequest.count} steps towards your perfect
            job!
          </p>
        </div>
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div
          className="graph-container-dark-background"

...
export const jobHaxClientSecret = "!!! Put your JobHax Client Secret here";
...
export const linkedInClientId = "!!! Put your LinkedIn Client ID here";

export const linkedInClientSecret = "!!! Put your LinkedIn Client Secret here";
